 ...
 * @author Brian Parra
 */
class Dref extends \Flare\FullBox {
    ...
    public function prepareForWriting(){
        ...
        \Flare\ByteUtils::writeUnsignedInteger($this->file, $this->entryCount); //Write the box size, place holder for now
