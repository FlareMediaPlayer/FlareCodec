 ...
 * @author Brian Parra
 */
class Hdlr extends \Flare\FullBox {
    ...
    function __construct($file) {
        ...
        $this->boxType = \Flare\Box::HDLR;
        parent::__construct($file);
    }

    public function loadData() {
        $this->readHeader();
        \Flare\ByteUtils::skipBytes($this->file, 4);
        $this->handlerType = \Flare\ByteUtils::read4Char($this->file);
        \Flare\ByteUtils::skipBytes($this->file, 12);
        ...
        $this->name = \Flare\ByteUtils::readString($this->file, $chars);
    }
    ...
    public function writeToFile() {
        ...
        \Flare\ByteUtils::writeChars($this->file, $this->handlerType); //Write the handler type
        
        \Flare\ByteUtils::padBytes($this->file, 12);
        \Flare\ByteUtils::writeCString($this->file, $this->name);
    }
