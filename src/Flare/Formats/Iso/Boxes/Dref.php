 ...
 * @author Brian Parra
 */
class Dref extends \Flare\Formats\Iso\FullBox {
    ...
    function __construct($file) {
        ...
        $this->boxType = \Flare\Formats\Iso\Box::DREF;
    ...
    public function prepareForWriting(){
        ...
        \Flare\Common\ByteUtils::writeUnsignedInteger($this->file, $this->entryCount); //Write the box size, place holder for now
