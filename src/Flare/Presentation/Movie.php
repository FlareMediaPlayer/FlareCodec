...
class Movie {
    ...
    public function __construct($iso) {
        ...
        $this->moov = new \Flare\Boxes\Moov($this->file); //Generate moov box
        $this->mvhd = new \Flare\Boxes\Mvhd($this->file); //Generate header
    ...
    public function addNewTrack(){
        $newTrack = new \Flare\Presentation\AudioTrack($this);
    ...
    public static function createNewAudioTrack($movie){
        $newTrack = new \Flare\Presentation\AudioTrack($movie);
